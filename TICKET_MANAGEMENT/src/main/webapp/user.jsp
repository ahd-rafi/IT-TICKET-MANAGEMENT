...
<a href= "raiseticket.jsp" class="button">RAISE TICKET</a><br>
</p>
<p style="text-align:center;">
<%
out.println("<a href= UserViewTickets?userid="+uid+" class = "+"button"+">VIEW TICKETS</a><br>");
%>
</p>
<p style="text-align:center;">
<a href= "login.jsp" class="button">LOGOUT</a><br>
</p>
</fieldset>
</form>
</body>
