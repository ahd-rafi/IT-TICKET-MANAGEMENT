...
<form method = "post" action="RaiseTicketController">
<fieldset>
<p>
<label for="id"><b style="color:black">USER ID</b></label><br>
<b style="color:black">
<%
out.println("<input type = text name = uid readonly = 'readonly' value = "+ session.getAttribute("uid")+">");
%>
</b>
</p>
<p>
<label ><b style="color:black">PRIORITY</b></label><br>
  ...
  <option value="low">LOW</option>
    ...
    <p>
<label for="sub"><b style="color:black">SUBJECT</b></label><br>
<input type = text name = sub >
</p>
<p>
<label for="desc"><b style="color:black">DESCRIPTION</b></label><br>
<input type = text  name = desc >
</p>
<p>
<label for="date"><b style="color:black">EXPECTED DATE OF RESOLVE</b></label><br>
 <input type="date" name="date">
 </p>
 <p class="p-container">
 <input type = submit name = submit value = "RAISE TICKET">
 </p>
 <p class="p-container">
