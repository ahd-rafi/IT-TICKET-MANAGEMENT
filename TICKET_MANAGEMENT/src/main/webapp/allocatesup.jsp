...
<form method = "post" action="AllocatingController">
<fieldset>
<p>
<span style="color:black"><b>TICKET ID</b></span><br>
<span style="color:black"><%
String tid = (String)request.getAttribute("tid");
out.println("<input type = text name = tid readonly = 'readonly' value = "+tid+">");
%></span>
</p>
<p>
<b style="color:black">SUPERVISOR</b><br>
<select name = "slct">
<%
ArrayList<UserData> arr =(ArrayList<UserData>)request.getAttribute("data");
for(UserData u : arr){
	String uid = u.getUserid();
	String uname = u.getUsername();
	String exp = u.getExpertise();
	out.println("<option value = "+uid+">"+uname+"</option>");
...
<select name = "allo">
<option value = "Supervisor_Allocated">Allocated</option>
...
<p>
<a href = ViewTicketController class = "button">BACK</a>
</p>
</fieldset>
</form>
</body>
